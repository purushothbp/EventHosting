...
const ToastProviderBase = ToastPrimitives.Provider;
...
// Export a custom ToastProvider that provides the toast function
export function ToastProvider({
  children,
  ...props
}: React.ComponentProps<typeof ToastProviderBase>) {
  ...
  return (
    <ToastContext.Provider value={{ toast }}>
      <ToastProviderBase {...props}>
        {children}
        {toastProps && (
          <Toast
            open={!!toastProps}
            onOpenChange={(open) => {
              if (!open) setToastProps(null);
            }}
